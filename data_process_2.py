...
def data_process(data_path, name, patch_size, stride, mode):
    ...
    for i, file in enumerate(file_list):
        ...
        # HVI added here !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!        
            ...
            img = Image.open(os.path.join(img_path, file))
            # [0:2] is simply picking the image number from the image name, i.e. 33_training.tif -> 33
            # gt = Image.open(os.path.join(gt_path, file[0:2] + "_manual1.gif"))
...
if __name__ == '__main__':
    ...
    # HVI added here !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  
                        help='the name of dataset',choices=['DRIVE','CHASEDB1','STARE','CHUAC','DCA1','HVI'],required=True)
